...
- [DLS & NRR engine](dls-nrr-engine.md) — points table auto-recomputes from scratch; server sole authority for result/points; DLS Standard Edition; scoring routes are /api/scoring/:matchId/* (comments lie); 3 known flaky tests
