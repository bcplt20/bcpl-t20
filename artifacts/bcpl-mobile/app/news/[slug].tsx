      ...
      <ScrollView contentContainerStyle={{ paddingBottom: Platform.OS === 'web' ? 60 : 30 }}>
        ...
        <View style={{ padding: 20, paddingTop: 0 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 16 }}>
            <View style={{ backgroundColor: '#FF1A75', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 }}>
          ...
          <LinearGradient colors={['#FF1A75', '#00E5FF']} start={{x: 0, y: 0}} end={{x: 1, y: 0}} style={{ height: 4, width: 60, marginBottom: 24, borderRadius: 2 }} />
              ...
              {article.press.map((p) => (
                ...
                >
                  <View style={styles.pressIcon}>
                    <Feather name="external-link" size={16} color="#00E5FF" />
                  </View>
