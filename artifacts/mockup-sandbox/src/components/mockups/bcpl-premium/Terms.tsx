...
export function Terms() {
  ...
  const sections = [
    ...
    {n:6,icon:'©',title:'Intellectual Property',items:[
      ...
      'BCPL name, logo, team names, and all associated marks are registered trademarks of Kriparti India Pvt. Ltd.',
            ...
            <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
              ...
              <div>
                ...
                <p style={{color:'rgba(255,255,255,0.85)',fontSize:14,lineHeight:1.7}}>
                  Contact our legal team at <strong style={{color:'#E8B23D'}}>legal@bcpl-t20.com</strong> or write to: Kriparti India Pvt. Ltd., New Delhi, India. We aim to respond within 5 business days.
                </p>
              </div>
            </div>
          </div>
