    ...
    <div style={{ background:'#06101E', minHeight:'100vh', fontFamily:"'Inter',sans-serif", color:'#F0EDE8', overflowX:'hidden', paddingBottom:100 }}>
      ...
      <div style={{ background:'linear-gradient(135deg,#060C18,#0A1F12)', borderBottom:'2px solid rgba(34,197,94,0.3)', padding:'40px 0' }}>
        <div className="wrap" style={{ textAlign:'center' }}>
          ...
          <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:'clamp(24px,4vw,44px)', color:'#22C55E', letterSpacing:'.02em', textTransform:'uppercase', marginBottom:8, animation:'fadeUp .5s ease .1s both' }}>
            KYC VERIFIED
          </div>
      ...
      {/* ── SEASON ROADMAP RAIL ── */}
      <div style={{ background:'#040C18', borderBottom:'1px solid rgba(255,255,255,0.06)', padding:'20px 0', overflowX:'auto' }}>
        <div className="wrap">
            ...
            {ROADMAP.map((node, i) => (
              <React.Fragment key={i}>
                <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:4, minWidth:64 }}>
                  ...
                  <div style={{ fontSize:9, fontWeight:700, fontFamily:'Montserrat,sans-serif', color: node.done ? '#22C55E' : node.active ? '#FF7A29' : 'rgba(255,255,255,0.3)', textAlign:'center', whiteSpace:'nowrap' }}>{node.label}</div>
                </div>
                {i < ROADMAP.length - 1 && (
                  <div style={{ flex:1, height:2, background: node.done ? '#22C55E' : 'rgba(255,255,255,0.08)', margin:'0 4px', marginBottom:16 }} />
                )}
              </React.Fragment>
            ))}
          </div>
      ...
      <div className="wrap" style={{ paddingTop:40 }}>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:24, marginBottom:32 }}>
          ...
          <div style={{ background:'#0A1727', border:'1px solid rgba(255,255,255,0.08)', borderTop:'3px solid #FF7A29' }}>
            <div style={{ padding:'20px 24px', borderBottom:'1px solid rgba(255,255,255,0.06)' }}>
              ...
              <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:28, color:'#fff', letterSpacing:'-.01em' }}>Rahul Sharma</div>
            </div>
            <div style={{ padding:'24px' }}>
              ...
              {[
                ...
                <div key={row.label} style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'10px 0', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
                  <div style={{ fontSize:11, color:'rgba(255,255,255,0.35)', fontWeight:600 }}>{row.label}</div>
                  <div style={{ fontSize:12, fontWeight:700, color: row.green ? '#22C55E' : 'rgba(255,255,255,0.8)', fontFamily: row.mono ? 'monospace' : 'inherit', fontSize: row.mono ? 11 : 12 }}>{row.value}</div>
                </div>
              ))}
          ...
          <div style={{ background:'#0A1727', border:'1px solid rgba(255,255,255,0.08)', borderTop:'3px solid #E8B23D' }}>
            <div style={{ padding:'20px 24px', borderBottom:'1px solid rgba(255,255,255,0.06)' }}>
              ...
              <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:22, color:'#fff' }}>Physical Trial Details</div>
            </div>
            <div style={{ padding:'24px' }}>
              {/* City */}
              <div style={{ marginBottom:24 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:12 }}>
                  ...
                  <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:32, color:'#fff' }}>Mumbai</div>
                </div>
              </div>
              ...
              {/* Date — COMING SOON */}
              <div style={{ background:'rgba(232,178,61,0.06)', border:'1px solid rgba(232,178,61,0.2)', padding:'20px', marginBottom:20 }}>
                ...
                <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:40, color:'#E8B23D', lineHeight:1, marginBottom:8, animation:'countdownPulse 2s ease infinite' }}>
                  COMING SOON
                </div>
        ...
        <div style={{ background:'linear-gradient(135deg,#0A1727,#060C18)', border:'1px solid rgba(255,122,41,0.2)', padding:'24px 28px', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:16 }}>
          <div>
          ...
          <button className="btn-primary" style={{ padding:'14px 32px', fontSize:14, letterSpacing:'.06em' }}>
