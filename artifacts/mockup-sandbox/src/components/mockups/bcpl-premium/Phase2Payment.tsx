    ...
    <div style={{ background:'#06101E', minHeight:'100vh', color:'#F0EDE8', fontFamily:"'Inter',sans-serif", overflowX:'hidden', paddingBottom:120 }}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-gold:disabled{opacity:.35;cursor:not-allowed;filter:none;transform:none;animation:none;clip-path:none}
        .ticket{background:#0A1727;border:1px solid rgba(232,178,61,0.35);position:relative;overflow:visible}
      ...
      <div className="wrap" style={{ paddingTop:32 }}>
        ...
        <div style={{ marginBottom:36 }}>
          ...
          <h1 style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:'clamp(26px,4vw,44px)', color:'#fff', letterSpacing:'.02em', lineHeight:1.1 }}>
        ...
        <div style={{ maxWidth:680, margin:'0 auto 40px' }}>
          <div className="ticket">
            {/* Gold header */}
            <div style={{ background:'linear-gradient(135deg,#E8B23D,#B8860B)', padding:'22px 32px' }}>
              <div style={{ fontSize:9, fontWeight:900, fontFamily:'Montserrat,sans-serif', letterSpacing:'.2em', color:'rgba(0,0,0,0.55)', marginBottom:6, textTransform:'uppercase' }}>BCPL Season 5 · Kriparti India</div>
              <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:18, color:'#fff', lineHeight:1.25, textShadow:'0 2px 8px rgba(0,0,0,0.3)' }}>PHASE 2 PHYSICAL TRIAL ENTRY · BCPL SEASON 5</div>
              <div style={{ marginTop:6, fontSize:11, fontWeight:700, color:'rgba(255,255,255,0.75)' }}>Brand Ambassador: Sourav Ganguly</div>
            </div>

            {/* Big price */}
            <div style={{ background:'#0A1727', padding:'28px 32px', textAlign:'center' }}>
              ...
              <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:64, color:'#fff', lineHeight:1, letterSpacing:'-0.02em' }}>₹2,000</div>
            ...
            {/* Receipt rows */}
            <div style={{ background:'#0A1727', padding:'20px 32px 24px' }}>
              {[
                ...
                <div key={k} style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'10px 0', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <span style={{ fontSize:13, color: k==='Phase 2 Amount' ? '#E8B23D' : '#fff', fontWeight:700, fontFamily:'Montserrat,sans-serif', letterSpacing: k.includes('Ref') ? '.06em' : 0 }}>{v}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="wrap" style={{ maxWidth:1200 }}>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))', gap:32, marginBottom:32 }}>
            ...
            <div>
              ...
              <div style={{ fontSize:13, color:'rgba(255,255,255,0.6)', lineHeight:1.7 }}>Kriparti India Pvt. Ltd.<br/>Brand Ambassador: Sourav Ganguly<br/>Season 5 · BCCI Certified Scouts</div>
            </div>
          </div>
          <div style={{ borderTop:'1px solid rgba(255,255,255,0.06)', paddingTop:20, display:'flex', justifyContent:'space-between', flexWrap:'wrap', gap:12 }}>
            <span style={{ fontSize:11, color:'rgba(255,255,255,0.25)' }}>© 2025 Kriparti India Pvt. Ltd. All rights reserved.</span>
