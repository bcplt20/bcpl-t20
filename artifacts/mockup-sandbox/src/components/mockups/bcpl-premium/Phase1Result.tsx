        ...
        <div>
          ...
          <div style={{ position:'relative', overflow:'hidden', paddingTop:56, paddingBottom:48, background:'#06101E' }}>
            ...
            <div className="wrap" style={{ textAlign:'center', position:'relative', zIndex:1 }}>
              ...
              <h1 style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:'clamp(32px,5vw,60px)', lineHeight:.95, textTransform:'uppercase', letterSpacing:'-.01em', marginBottom:12, animation:'fadeUp .5s ease .1s both' }}>
          ...
          <div className="wrap" style={{ paddingTop:40, paddingBottom:80 }}>
            <div style={{ display:'grid', gridTemplateColumns:'1fr', gap:24 }}>
              ...
              <div style={{ background:'#0A1727', border:'1px solid rgba(232,178,61,0.25)', borderLeft:'4px solid #E8B23D', padding:'24px 28px' }}>
                ...
                <blockquote style={{ fontSize:15, color:'rgba(255,255,255,0.75)', lineHeight:1.7, fontStyle:'italic', borderLeft:'2px solid rgba(232,178,61,0.3)', paddingLeft:16, margin:'0 0 16px' }}>
              ...
              <div style={{ background:'#0A1727', border:'1px solid rgba(255,122,41,0.25)' }}>
                {/* Header */}
                <div style={{ background:'linear-gradient(135deg,rgba(255,122,41,0.15),rgba(255,122,41,0.05))', borderBottom:'1px solid rgba(255,122,41,0.2)', padding:'20px 28px' }}>
                  ...
                  <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:22, color:'#fff' }}>PHASE 2 — PHYSICAL TRIAL</div>
                </div>
                <div style={{ padding:'24px 28px' }}>
                  ...
                  {/* Mini match-ticket */}
                  <div style={{ background:'#060C18', border:'1px solid rgba(255,122,41,0.3)', padding:'16px 20px', display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
                    <div>
                    ...
                    <div style={{ fontFamily:'Montserrat,sans-serif', fontWeight:900, fontSize:42, color:'#FF7A29' }}>₹2,000</div>
                  </div>
      ...
      {result === 'rejected' && (
        <div>
          ...
          <div className="wrap" style={{ paddingTop:40, paddingBottom:80, maxWidth:680 }}>
            {/* Refund notice */}
            <div style={{ background:'#0A1727', border:'1px solid rgba(255,255,255,0.08)', borderLeft:'4px solid rgba(255,255,255,0.2)', padding:'20px 24px', marginBottom:24 }}>
            ...
            {/* Encouragement */}
            <div style={{ background:'rgba(255,122,41,0.05)', border:'1px solid rgba(255,122,41,0.15)', padding:'20px 24px', marginBottom:24 }}>
            ...
            {/* Season 6 notify */}
            <div style={{ background:'#0A1727', border:'1px solid rgba(255,255,255,0.08)', padding:'24px' }}>
              ...
              <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
                <input className="field-inp" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email address" style={{ flex:1, minWidth:220 }} />
