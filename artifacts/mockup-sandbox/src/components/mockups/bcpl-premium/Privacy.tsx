    ...
    <div style={{background:'#060E1C',minHeight:'100vh',fontFamily:'Inter,sans-serif',color:'#F8F4EE',paddingBottom:80}}>
      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <div className="wrap" style={{maxWidth:860,margin:'0 auto',paddingBottom:40}}>
          ...
          {/* Green callout at top */}
          <div style={{background:'rgba(34,197,94,0.1)',border:'2px solid rgba(34,197,94,0.4)',borderLeft:'4px solid #22C55E',borderRadius:16,padding:'20px 24px',marginBottom:24,animation:'fadeSlide 0.5s ease 0.1s both'}}>
            <div style={{display:'flex',gap:12,alignItems:'center'}}>
              ...
              <div>
                ...
                <p style={{color:'rgba(255,255,255,0.85)',fontSize:15,fontWeight:600}}>We <strong style={{color:'#22C55E'}}>NEVER sell your data to third parties. Ever.</strong> Your information is used solely to run BCPL T20 Season 5.</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card" style={{padding:'32px',textAlign:'center'}}>
            <div style={{fontFamily:'Montserrat,sans-serif',fontWeight:900,fontSize:22,marginBottom:8}}>Your Data Is Safe With Us</div>
            ...
            <button className="btn-fire" style={{padding:'14px 36px',fontSize:16}}>Register Securely →</button>
          </div>
        </div>
