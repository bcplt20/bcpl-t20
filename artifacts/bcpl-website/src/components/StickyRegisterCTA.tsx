...
const CSS = `
  .srg-bar{position:fixed;left:0;right:0;bottom:0;z-index:900;display:flex;gap:10px;align-items:stretch;background:rgba(16,34,61,.97);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-top:1px solid rgba(255,255,255,0.18);padding:10px 16px calc(12px + env(safe-area-inset-bottom,0px));}
