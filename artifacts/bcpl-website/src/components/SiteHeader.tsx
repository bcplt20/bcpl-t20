...
/* Mobile menu — clean single list (no section headings). Players and Auction
   are reachable via quick-links on the Match Centre page instead.
...
const CSS = `
  ...
  .sh-moblink{padding:13px 0;border-bottom:1px solid rgba(255,255,255,0.18);font-family:'Barlow Condensed','Mukta',sans-serif;font-weight:800;font-size:23px;letter-spacing:.05em;color:rgba(255,255,255,0.88);text-transform:uppercase;cursor:pointer;text-decoration:none;display:block;}
