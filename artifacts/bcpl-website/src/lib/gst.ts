 ...
 * players actually paid: base fee + 18% GST already included
 * (api: Math.round(FEES[role].phaseN * 1.18)).
 *
 * So GST must be extracted OUT of the stored amount, never added on top:
 *   ₹353 = ₹299.15 base + ₹53.85 GST (CGST ₹26.92 + SGST ₹26.93)
 *
