          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.4s both'}}>
            ...
            <div style={{display:'grid',gap:12}}>
              {[
                ...
                {icon:'🎥',titleEn:'Cricket Video',titleHi:'Cricket Video',descEn:'Uploaded post-registration via the BCPL portal. 2-5 minutes. Clear footage of your cricketing skills in natural light.',descHi:'Registration के बाद BCPL portal से upload होती है। 2-5 minutes। Natural light में आपकी cricketing skills की clear footage।'},
              ].map((item,i)=>(
