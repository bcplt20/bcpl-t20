    ...
    <div style={{background:'#071B15',minHeight:'100vh',fontFamily:'Inter,sans-serif',color:'#F8F4EE',paddingBottom:80,overflowX:'hidden'}}>
      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <div className="wrap" style={{maxWidth:860,margin:'0 auto',paddingBottom:40}}>
          ...
          {/* KEY POINTS */}
          <div style={{background:'rgba(212,175,55,0.06)',border:'1px solid rgba(212,175,55,0.25)',borderRadius:16,padding:'20px clamp(16px,4vw,26px)',marginBottom:24,animation:'fadeSlide 0.5s ease 0.05s both'}}>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.25s both'}}>
            ...
            <div style={{display:'flex',gap:20,flexWrap:'wrap',marginBottom:16}}>
              <div style={{background:'linear-gradient(135deg,rgba(212,175,55,0.15),rgba(232,178,61,0.1))',border:'1px solid rgba(212,175,55,0.3)',borderRadius:14,padding:'16px 24px',textAlign:'center',flex:1,minWidth:120}}>
                <div style={{fontFamily:'Montserrat,sans-serif',fontWeight:900,fontSize:36,color:'#D4AF37',lineHeight:1}}>18+</div>
          ...
          <div style={{background:'rgba(212,175,55,0.08)',border:'1px solid rgba(212,175,55,0.4)',borderLeft:'3px solid #D4AF37',borderRadius:16,padding:'20px clamp(16px,4vw,24px)',marginBottom:20,animation:'borderGlow 3s ease-in-out infinite'}}>
            <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
              <span style={{flexShrink:0,color:'#D4AF37',display:'inline-flex'}}><IcoList size={24}/></span>
              <div>
                <div style={{fontFamily:'Montserrat,sans-serif',fontWeight:800,fontSize:15,color:'#D4AF37',marginBottom:6}}>{t("Registration Journey","Registration Journey")}</div>
                <div style={{display:'flex',gap:8,alignItems:'center',flexWrap:'wrap'}}>
                  {[
                    ...
                    <React.Fragment key={i}>
                      <span style={{background:'rgba(212,175,55,0.15)',border:'1px solid rgba(212,175,55,0.3)',borderRadius:8,padding:'5px 12px',fontSize:12,color:'#D4AF37',fontWeight:700,fontFamily:'Montserrat,sans-serif'}}>{t(step.en,step.hi)}</span>
                      {i<arr.length-1&&<span style={{color:'rgba(212,175,55,0.5)',fontSize:16}}>→</span>}
                    </React.Fragment>
                  ))}
                </div>
              </div>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.45s both'}}>
            ...
            <div style={{background:'rgba(212,175,55,0.06)',border:'1px solid rgba(212,175,55,0.2)',borderRadius:12,padding:'14px 18px',marginTop:16}}>
              <p style={{color:'rgba(255,255,255,0.7)',fontSize:'clamp(13px,2vw,14px)',lineHeight:1.7}}>
                ...
                {' '}
                <Link href="/code-of-conduct" style={{color:'#D4AF37',fontWeight:700,textDecoration:'underline'}}>{t("Read the Code of Conduct →","Code of Conduct पढ़ें →")}</Link>
              </p>
            </div>
          </div>
