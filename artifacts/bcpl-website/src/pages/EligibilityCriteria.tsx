      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <div className="wrap" style={{maxWidth:860,margin:'0 auto',paddingBottom:40}}>
          ...
          <div style={{background:'rgba(255,122,41,0.06)',border:'1px solid rgba(255,122,41,0.25)',borderRadius:16,padding:'20px clamp(16px,4vw,26px)',marginBottom:24,animation:'fadeSlide 0.5s ease 0.05s both'}}>
            ...
            <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:9}}>
              {[
                ...
                <li key={i} style={{display:'flex',alignItems:'flex-start',color:'rgba(255,255,255,0.88)',fontSize:'clamp(13px,2vw,14.5px)',lineHeight:1.7}}>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:24,animation:'fadeSlide 0.5s ease 0.1s both'}}>
            ...
            <p style={{color:'rgba(255,255,255,0.88)',fontSize:13,marginBottom:24}}>{t("Answer 3 quick questions to find out if you qualify for Season 5.","3 quick सवालों के जवाब दें और जानें कि आप Season 5 के लिए qualify करते हैं या नहीं।")}</p>
            <div style={{display:'flex',flexDirection:'column',gap:16}}>
              {questions.map((q,i)=>(
                <div key={i} style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'nowrap',gap:10}}>
                  <span style={{color:'rgba(255,255,255,0.88)',fontSize:15,fontWeight:600,fontFamily:'Inter,sans-serif'}}>{t(q.labelEn,q.labelHi)}</span>
              ...
              <div style={{marginTop:24}}>
                {allYes ? (
                  ...
                  <div style={{background:'rgba(232,73,63,0.1)',border:'2px solid rgba(232,73,63,0.4)',borderRadius:16,padding:'20px 24px',textAlign:'center'}}>
                    ...
                    <p style={{color:'rgba(255,255,255,0.88)',fontSize:14,marginBottom:16}}>{t("Based on your answers, you don't qualify this season. We'd love to have you in a future edition!","आपके जवाबों के आधार पर, आप इस season qualify नहीं करते। हमें आपको किसी future edition में देखकर खुशी होगी!")}</p>
                    <button style={{background:'rgba(255,255,255,0.18)',border:'1px solid rgba(255,255,255,0.2)',borderRadius:12,color:'rgba(255,255,255,0.88)',padding:'10px 24px',fontSize:14,cursor:'pointer',fontFamily:'Inter,sans-serif',minHeight:44,width:'100%',maxWidth:280}}>{t("Contact us for future seasons →","Future seasons के लिए हमसे contact करें →")}</button>
                  </div>
                ) : null}
              </div>
            )}
            ...
            <div className="elig-2col">
              <div style={{background:'rgba(34,197,94,0.08)',border:'1px solid rgba(34,197,94,0.2)',borderRadius:12,padding:'14px 16px'}}>
                ...
                {[
                  ...
                  <div key={i} style={{display:'flex',alignItems:'flex-start',gap:6,color:'rgba(255,255,255,0.88)',fontSize:13,lineHeight:1.6,marginBottom:4}}>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.25s both'}}>
            ...
            <div style={{display:'flex',gap:20,flexWrap:'wrap',marginBottom:16}}>
              <div style={{background:'linear-gradient(135deg,rgba(255,122,41,0.15),rgba(232,178,61,0.1))',border:'1px solid rgba(255,122,41,0.3)',borderRadius:14,padding:'16px 24px',textAlign:'center',flex:1,minWidth:120}}>
                ...
                <div style={{color:'rgba(255,255,255,0.88)',fontSize:13,marginTop:4}}>{t("Minimum Age","Minimum Age")}</div>
              </div>
              <div style={{background:'linear-gradient(135deg,rgba(34,197,94,0.1),rgba(34,197,94,0.05))',border:'1px solid rgba(34,197,94,0.2)',borderRadius:14,padding:'16px 24px',textAlign:'center',flex:1,minWidth:120}}>
                ...
                <div style={{color:'rgba(255,255,255,0.88)',fontSize:13,marginTop:4}}>{t("Maximum Age","Maximum Age")}</div>
              </div>
            </div>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.3s both'}}>
            ...
            <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:10}}>
              {[
                ...
                {en:'Skills assessed via a 30–90 second video uploaded within 15 days of registration',hi:'Skills registration के 15 दिनों के अंदर upload की गई 30–90 second video से assess होती हैं'},
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.4s both'}}>
            ...
            <p style={{color:'rgba(255,255,255,0.88)',fontSize:'clamp(14px,2vw,15px)',lineHeight:1.8,marginBottom:18}}>
            ...
            <div style={{display:'grid',gap:12}}>
              {([
                {icon:IcoIdCard,titleEn:'Identity Proof',titleHi:'Identity Proof',descEn:'Aadhaar Card or PAN Card (any one). Must be government-issued and valid. Name must match registration details exactly.',descHi:'Aadhaar Card या PAN Card (कोई एक)। Government-issued और valid होना चाहिए। Name registration details से बिलकुल match होना चाहिए।'},
                {icon:IcoCamera,titleEn:'Passport Photo',titleHi:'Passport Photo',descEn:'Recent colour photograph (taken within 3 months). Digital copy accepted — minimum 300 DPI resolution.',descHi:'हाल की colour photograph (पिछले 3 months में ली गई)। Digital copy चलेगी — minimum 300 DPI resolution।'},
                ...
                {icon:IcoVideo,titleEn:'Cricket Video',titleHi:'Cricket Video',descEn:'Uploaded within 15 days of registration via the BCPL portal. 30–90 seconds. Clear footage of your own, current cricket performance in natural light.',descHi:'Registration के 15 दिनों के अंदर BCPL portal से upload होती है। 30–90 seconds। Natural light में आपकी own, current cricket performance की clear footage।'},
              ] as {icon:IcoComp;titleEn:string;titleHi:string;descEn:string;descHi:string}[]).map((item,i)=>(
                <div key={i} style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.18)',borderRadius:12,padding:'14px 16px',display:'flex',gap:12}}>
                  ...
                  <div>
                    ...
                    <div style={{color:'rgba(255,255,255,0.88)',fontSize:13,lineHeight:1.6}}>{t(item.descEn,item.descHi)}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={{background:'rgba(255,122,41,0.08)',border:'1px solid rgba(255,122,41,0.4)',borderLeft:'3px solid #FF7A29',borderRadius:16,padding:'20px clamp(16px,4vw,24px)',marginBottom:20,animation:'borderGlow 3s ease-in-out infinite'}}>
            <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
              <span style={{flexShrink:0,color:'#FF7A29',display:'inline-flex'}}><IcoList size={24}/></span>
              <div>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.45s both'}}>
            ...
            <p style={{color:'rgba(255,255,255,0.88)',fontSize:'clamp(14px,2vw,15px)',lineHeight:1.8,marginBottom:16}}>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px)',textAlign:'center'}}>
            ...
            <p style={{color:'rgba(255,255,255,0.88)',fontSize:14,marginBottom:20}}>{t("Join 10 franchise teams and corporate cricketers from across India. Your stadium moment awaits.","10 franchise teams और पूरे भारत के corporate cricketers के साथ जुड़ें। आपका stadium वाला पल इंतज़ार कर रहा है।")}</p>
