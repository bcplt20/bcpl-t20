        ...
        <div className="wrap" style={{maxWidth:860,margin:'0 auto',paddingBottom:40}}>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.4s both'}}>
            ...
            <div style={{display:'grid',gap:12}}>
              {[
                ...
                {level:'Level 2',color:'#D4AF37',bg:'rgba(212,175,55,0.1)',border:'rgba(212,175,55,0.3)',badge:'Score Invalidation',desc:'Repeated Level 1 conduct, or conduct that compromises the fairness of an assessment. May include invalidation of the affected trial/assessment score or attempt.'},
          ...
          <div style={{background:'rgba(212,175,55,0.08)',border:'1px solid rgba(212,175,55,0.4)',borderLeft:'3px solid #D4AF37',borderRadius:16,padding:'20px clamp(16px,4vw,24px)',marginBottom:20,animation:'borderGlow 3s ease-in-out infinite'}}>
            <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
              ...
              <div>
                <div style={{fontFamily:'Montserrat,sans-serif',fontWeight:800,fontSize:15,color:'#D4AF37',marginBottom:6}}>Serious Violations</div>
                <p style={{color:'rgba(255,255,255,0.85)',fontSize:'clamp(13px,2vw,14px)',lineHeight:1.7}}>
                  A confirmed <strong style={{color:'#D4AF37'}}>Level 3 or Level 4</strong> violation may result in <strong style={{color:'#E8493F'}}>disqualification or a season ban</strong> following the fair disciplinary process. Fee treatment in such cases follows the applicable <Link href="/refunds" style={{color:'#E8B23D',fontWeight:600}}>Refund &amp; Cancellation Policy</Link>. Participants may raise concerns through the published BCPL grievance process.
                </p>
              </div>
            </div>
          </div>
