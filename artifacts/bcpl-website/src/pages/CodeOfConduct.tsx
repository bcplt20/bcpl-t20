      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <div className="wrap" style={{maxWidth:860,margin:'0 auto',paddingBottom:40}}>
              ...
              {([
                ...
                <div key={i} style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.18)',borderRadius:12,padding:'14px 16px',display:'flex',gap:12}}>
                  ...
                  <div>
                    ...
                    <div style={{color:'rgba(255,255,255,0.88)',fontSize:13,lineHeight:1.6}}>{item.desc}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',marginBottom:20,animation:'fadeSlide 0.5s ease 0.4s both'}}>
            ...
            <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.18)',borderRadius:12,padding:'14px 16px',marginBottom:20}}>
            ...
            <p style={{color:'rgba(255,255,255,0.88)',fontSize:'clamp(14px,2vw,15px)',lineHeight:1.8,marginBottom:20}}>
            ...
            <div style={{display:'grid',gap:12}}>
              {[
                ...
                <div key={i} style={{background:item.bg,border:`1px solid ${item.border}`,borderRadius:12,padding:'14px 18px',display:'flex',gap:14,alignItems:'flex-start',flexWrap:'wrap'}}>
                  ...
                  <div style={{color:'rgba(255,255,255,0.88)',fontSize:13,lineHeight:1.6,flex:1,minWidth:180}}>{item.desc}</div>
                </div>
              ))}
            </div>
          </div>
