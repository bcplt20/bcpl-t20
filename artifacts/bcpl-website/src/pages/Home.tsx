...
const ROAD = (f: FeeConfig) => [
  ...
  { icon:"video", en:"Video Trial",      hi:"वीडियो ट्रायल",  date:"Within 15 days",    fee:null,                                                      descEn:"Upload a 30–90 second cricket clip from any ground in India.",                                          descHi:"किसी भी मैदान से 30–90 second की cricket clip upload करें।",                                       color:"#FF9350" },
