...
export function Refunds() {
  ...
  const css = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .toc-link:hover{background:rgba(212,175,55,.08);color:#D4AF37;border-color:rgba(212,175,55,.2);}
        ...
        <div className="wrap" style={{maxWidth:900,margin:'0 auto',paddingBottom:40}}>
          ...
          <div className="glass-card" style={{padding:'clamp(18px,4vw,26px)',marginBottom:24,animation:'fadeSlide 0.5s ease 0.2s both'}}>
            <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:14}}>
              <span style={{color:'#D4AF37',display:'inline-flex',alignItems:'center'}}><IcoRoute size={18}/></span>
            ...
            <div className="toc-grid">
              {SECTIONS.map(s=>(
                <a key={s.n} href={`#refund-${s.n}`} className="toc-link" onClick={(e)=>{e.preventDefault();setOpen(s.n);setTimeout(()=>document.getElementById(`refund-${s.n}`)?.scrollIntoView({behavior:'smooth',block:'start'}),40);}}>
                  <span style={{width:24,height:24,borderRadius:'50%',background:'rgba(212,175,55,.15)',border:'1px solid rgba(212,175,55,.3)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:800,color:'#D4AF37',flexShrink:0,fontFamily:'Montserrat,sans-serif'}}>{s.n}</span>
            ...
            return (
              <div key={s.n} id={`refund-${s.n}`} className="glass-card" style={{padding:'clamp(16px,4vw,24px) clamp(16px,4vw,30px)',marginBottom:12,scrollMarginTop:90,animation:`fadeSlide 0.4s ease ${Math.min(0.05+idx*0.02,0.4)}s both`}}>
                <button className="acc-head" onClick={()=>setOpen(isOpen?null:s.n)} aria-expanded={isOpen}>
                  <div style={{width:32,height:32,borderRadius:'50%',background:'linear-gradient(135deg,rgba(212,175,55,0.3),rgba(232,178,61,0.2))',border:'1px solid rgba(212,175,55,0.4)',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Montserrat,sans-serif',fontWeight:900,fontSize:13,color:'#D4AF37',flexShrink:0}}>{s.n}</div>
                  <span style={{color:'#D4AF37',display:'inline-flex',alignItems:'center',flexShrink:0}}><s.icon size={18}/></span>
          ...
          <div className="glass-card" style={{padding:'clamp(20px,4vw,32px) clamp(16px,4vw,36px)',margin:'24px 0',border:'1px solid rgba(212,175,55,0.2)'}}>
            <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:20}}>
              <span style={{color:'#D4AF37',display:'inline-flex',alignItems:'center'}}><IcoPen size={24}/></span>
          ...
          <div style={{background:'rgba(212,175,55,0.08)',border:'1px solid rgba(212,175,55,0.4)',borderLeft:'3px solid #D4AF37',borderRadius:16,padding:'20px clamp(16px,4vw,24px)',marginBottom:20,animation:'borderGlow 3s ease-in-out infinite'}}>
            <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
              <span style={{flexShrink:0,color:'#D4AF37',display:'inline-flex'}}><IcoChat size={24}/></span>
              <div>
                <div style={{fontFamily:'Montserrat,sans-serif',fontWeight:800,fontSize:15,color:'#D4AF37',marginBottom:6}}>Have Questions?</div>
