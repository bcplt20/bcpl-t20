...
const SPONSOR_TIERS = [
  ...
  { labelEn:'PRESENTING SPONSOR', labelHi:'PRESENTING SPONSOR', color:'#D4AF37', descEn:'Premium partner status with prominent placement at all trial cities and match venues.', descHi:'सभी trial cities और match venues पर prominent placement के साथ premium partner status।' },
    ...
    <div style={{background:'#071B15',color:'#fff',minHeight:'100vh',overflowX:'hidden',fontFamily:'Inter,sans-serif'}}>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        @keyframes borderGlow{0%,100%{border-color:rgba(212,175,55,0.25)}50%{border-color:rgba(212,175,55,0.7)}}
        @keyframes orangeGlow{0%,100%{border-color:rgba(212,175,55,0.2)}50%{border-color:rgba(212,175,55,0.6)}}
      ...
      <div style={{position:'fixed',inset:0,zIndex:0,pointerEvents:'none',overflow:'hidden'}}>
        ...
        {[{top:'15%',left:'10%',c:'#D4AF37',d:'0s'},{top:'60%',left:'5%',c:'#E8B23D',d:'1.2s'},{top:'30%',left:'90%',c:'#fff',d:'2.4s'},{top:'75%',left:'85%',c:'#D4AF37',d:'0.6s'},{top:'50%',left:'50%',c:'#E8B23D',d:'1.8s'},{top:'10%',left:'70%',c:'#fff',d:'3s'},{top:'85%',left:'30%',c:'#D4AF37',d:'0.3s'},{top:'40%',left:'20%',c:'#E8B23D',d:'2.1s'}].map((p,i)=>(
      ...
      <div style={{position:'relative',zIndex:1}}>
          ...
          <div className="wrap">
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr',gap:20}}>
              {SPONSOR_TIERS.map((tier,i)=>(
                <div key={tier.labelEn} style={{background:'linear-gradient(135deg,rgba(10,59,46,0.92),rgba(6,35,28,0.88))',backdropFilter:'blur(24px)',border:`1.5px dashed ${tier.color}55`,borderRadius:20,padding:'28px 24px',display:'flex',alignItems:'center',gap:20,flexWrap:'wrap'}}>
        ...
        <section style={{padding:'0 0 80px'}}>
          <div className="wrap">
            <div style={{background:'linear-gradient(135deg,rgba(10,59,46,0.96),rgba(6,35,28,0.92))',backdropFilter:'blur(32px)',border:'1px solid rgba(212,175,55,0.2)',borderRadius:24,padding:'48px 32px',animation:'borderGlow 3s ease-in-out infinite'}}>
              <div style={{textAlign:'center',marginBottom:40}}>
              ...
              <div className="stats-row" style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:14,marginBottom:40}}>
                {[
                  ...
                  <div key={i} style={{background:'rgba(212,175,55,0.06)',border:'1px solid rgba(212,175,55,0.15)',borderRadius:14,padding:'20px 16px',textAlign:'center'}}>
                    <div style={{fontFamily:'var(--font-head)',fontWeight:900,fontSize:24,color:'#D4AF37',marginBottom:4}}>{t(s.valEn,s.valHi)}</div>
