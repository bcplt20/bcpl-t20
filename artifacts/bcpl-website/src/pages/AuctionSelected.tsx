          ...
          <div style={{ position:'relative', zIndex:1 }}>
            ...
            <div className="cta-btn-group">
              <button className="btn-gold" style={{ padding:'13px 28px', fontSize:13 }}
                onClick={() => { const msg = encodeURIComponent('🏆 Remind me about BCPL Season 5 Franchise Auction — August 2026! #OfficeSeStadiumtak'); window.open(`https://wa.me/919151346555?text=${msg}`, '_blank'); }}>SET AUCTION REMINDER →</button>
