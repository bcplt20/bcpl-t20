                ...
                <div style={{ padding: '26px 24px 30px' }}>
                  <div style={{ display: 'flex', gap: 22, flexWrap: 'wrap', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      {data.checkedInAt && (
                        <div style={{ marginTop: 8, display: 'inline-block', background: 'rgba(34,197,94,0.15)', border: '1px solid rgba(34,197,94,0.4)', color: '#4ADE80', borderRadius: 100, padding: '4px 12px', font: '700 11px var(--font-body)' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 240 }}>
                      ...
                      <div style={{ font: '600 12px var(--font-body)', color: '#E8B23D', marginBottom: 14 }}>{data.player.role} · {data.player.city ?? ''}</div>
                  ...
                  <div className="tp-note" style={{ marginTop: 22, background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '12px 16px', font: '500 12px var(--font-body)', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7 }}>
                    {t(
