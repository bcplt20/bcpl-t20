      ...
      <div className="W" style={{ paddingTop: 48 }}>
        ...
        <div className="notices-grid">
          {[
            ...
            { icon:'🏋️', title: t('Prepare Now', 'तैयारी शुरू करें'), body: t('Train consistently. Scouts value fitness and skill. Focus on your strengths — batting technique, bowling rhythm, or all-round conditioning.', 'लगातार ट्रेनिंग करें। स्काउट्स फिटनेस और स्किल को महत्व देते हैं। अपनी ताकत पर ध्यान दें।'), cta: t('View Training Tips →', 'ट्रेनिंग टिप्स देखें →'), color: 'var(--orange)', onClick: () => { const el = document.getElementById('training-tips'); if(el) el.scrollIntoView({behavior:'smooth'}); } },
        ...
        <div id="training-tips" style={{ background: 'var(--panel)', border: '1px solid rgba(255,122,41,0.3)', borderRadius: 'var(--r)', padding: '32px 24px', marginBottom: 40 }}>
          ...
          <div style={{ fontSize: 15, color: 'rgba(255,255,255,0.5)', marginBottom: 28 }}>{t("Franchise scouts evaluate these key areas during the ground trial", "फ्रैंचाइज़ी स्काउट्स ग्राउंड ट्रायल के दौरान इन प्रमुख क्षेत्रों का मूल्यांकन करते हैं")}</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(240px,1fr))', gap: 16 }}>
            {[
              { icon:'🏃', title: t('Fitness First', 'पहले फिटनेस'), tip: t('30 min cardio daily. Scouts notice your stamina in the last over as much as the first.', 'रोज़ 30 मिनट कार्डियो। स्काउट्स आपकी स्टैमिना पर ध्यान देते हैं।') },
