  ...
  return (
    <div className="page-root">
      <style>{`
        ...
        .btn-cta:hover { transform: translateY(-2px); box-shadow: 0 10px 20px rgba(212,175,55,0.3); }
        ...
        .notice-card:hover { border-color: rgba(212,175,55,0.4); }
        ...
        @keyframes pulseOrange { 0%,100% { box-shadow: 0 0 0 0 rgba(212,175,55,0.5); } 50% { box-shadow: 0 0 0 12px rgba(212,175,55,0); } }
        ...
        .season-cta { background: linear-gradient(135deg, var(--panel), #081E18); border: 1px solid rgba(212,175,55,0.3); padding: 32px 24px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px; border-radius: var(--r); }
        ...
        <div className="W" style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div className="hero-chips" style={{ animation: 'fadeUp .5s ease .3s both' }}>
            {[
              ...
              { label: t('Trial: Upcoming', 'ट्रायल: आगामी'), color: 'var(--orange)', bg: 'rgba(212,175,55,0.1)', border: 'rgba(212,175,55,0.4)' },
            ].map(c => (
      ...
      <div className="W" style={{ paddingTop: 48 }}>
          ...
          <div style={{ background: 'var(--panel)', border: '1px solid var(--line)', borderTop: '4px solid var(--orange)', borderRadius: 'var(--r)' }}>
            ...
            <div style={{ padding: '24px' }}>
              <div style={{ display: 'flex', gap: 12, marginBottom: 24, flexWrap: 'wrap' }}>
                ...
                <div className="chip" style={{ background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.3)', color: 'var(--orange)', display: 'inline-flex', alignItems: 'center', gap: 6 }}><IcoPin size={16} /> {playerCity}</div>
              </div>
        ...
        {/* ── TRAINING TIPS ── */}
        <div id="training-tips" style={{ background: 'var(--panel)', border: '1px solid rgba(212,175,55,0.3)', borderRadius: 'var(--r)', padding: '32px 24px', marginBottom: 40 }}>
