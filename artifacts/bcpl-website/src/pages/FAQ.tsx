...
const FAQS = (F: FeeConfig) => [
  ...
  {cat:'Registration',qEn:'What happens after I register?',qHi:'Register करने के बाद क्या होता है?',aEn:'You\'ll receive a confirmation email with your unique registration ID. You then need to upload a 30–90 second cricket skills video within 15 days of registration. Your submission goes through BCPL\'s Phase 1 evaluation process and you receive a result within 15 days.',aHi:'आपको registration ID के साथ confirmation email मिलेगा। फिर आपको 15 दिनों के अंदर 30–90 second cricket skills video upload करना होगा। आपकी submission BCPL के Phase 1 evaluation process से गुज़रती है और result 15 दिनों के भीतर मिलता है।'},
  ...
  // Phase 1
  {cat:'Phase 1',qEn:'What is Phase 1?',qHi:'Phase 1 क्या है?',aEn:'Phase 1 is a video-based assessment stage. After registering, you upload a 30–90 second cricket skills video within 15 days. Your submission is assessed under BCPL\'s role-specific Phase 1 framework, and your result is shared within 15 days of video submission.',aHi:'Phase 1 एक video-based assessment stage है। Register करने के बाद, आप 15 दिनों के अंदर 30–90 second cricket skills video upload करते हैं। आपकी submission BCPL के role-specific Phase 1 framework के तहत assess होती है, और result video submission के 15 दिनों के भीतर share किया जाता है।'},
  ...
  {cat:'Phase 1',qEn:'What video format and duration are accepted?',qHi:'कौन सा video format और duration accept होता है?',aEn:'A 30–90 second cricket skills video showing your own, current performance for your role. Please follow the Phase 1 Video Rules for the accepted formats, quality and content requirements.',aHi:'30–90 second cricket skills video जिसमें आपकी role के लिए आपका अपना, current performance दिखे। Accepted formats, quality और content requirements के लिए Phase 1 Video Rules देखें।',linkTo:'/trust',linkLabelEn:'How Selection Works',linkLabelHi:'How Selection Works'},
  {cat:'Phase 1',qEn:'When will my Phase 1 result appear and will I see a score and rank?',qHi:'मेरा Phase 1 result कब आएगा और क्या मुझे score और rank दिखेगी?',aEn:'Your Phase 1 result is shared within 15 days of video submission. Your result may include a score and/or a ranking where applicable. Scores are assessed against a role-specific 100-point framework, and a score does not by itself guarantee advancement.',aHi:'आपका Phase 1 result video submission के 15 दिनों के भीतर share किया जाता है। आपके result में जहां लागू हो score और/या ranking शामिल हो सकती है। Scores एक role-specific 100-point framework पर assess होते हैं, और कोई score अपने आप advancement की गारंटी नहीं देता।',linkTo:'/trust',linkLabelEn:'How Selection Works',linkLabelHi:'How Selection Works'},
