...
const FAQS = (F: FeeConfig) => [
  ...
  {cat:'Eligibility',qEn:'Is there an age limit?',qHi:'क्या कोई age limit है?',aEn:'Yes. Players must be 18 to 45 years of age as on the date of registration, as set out in the Eligibility Criteria.',aHi:'हाँ। Eligibility Criteria के अनुसार players की उम्र registration की तारीख़ पर 18 से 45 साल होनी चाहिए।'},
  // Phase 1
