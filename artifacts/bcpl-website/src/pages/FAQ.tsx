...
const FAQS = (F: FeeConfig) => [
  ...
  // Selection
  {cat:'Selection',qEn:'How does the video evaluation work?',qHi:'Video evaluation कैसे काम करता है?',aEn:'After uploading your 30–60 second skills video, it is evaluated against BCPL\'s Phase 1 assessment criteria, with the result released within 48 hours. Each video is assessed anonymously on specific skill criteria relevant to your registered role. You receive a detailed result via email.',aHi:'आपका 30–60 second skills video upload होने के बाद, वह BCPL के Phase 1 assessment criteria पर evaluate होता है और result 48 घंटे में मिलता है। हर video को anonymously specific skill criteria पर assess किया जाता है। आपको email पर detailed result मिलता है।'},
  ...
  {cat:'Selection',qEn:'What is the franchise auction?',qHi:'Franchise auction क्या है?',aEn:'The 10 BCPL franchise teams (Delhi Dynamos, Mumbai Mavericks, Pune Panthers, etc.) bid for players from the trial pool. Players selected in the auction pay no additional BCPL tournament participation fee for the Season 5 tournament — subject to the applicable BCPL Season 5 rules and any expressly disclosed exceptions.',aHi:'10 BCPL franchise teams (Delhi Dynamos, Mumbai Mavericks, Pune Panthers, etc.) trial pool के players के लिए bid करती हैं। Auction में select हुए players को Season 5 tournament के लिए कोई अतिरिक्त BCPL tournament participation fee नहीं देनी होती — लागू BCPL Season 5 नियमों और स्पष्ट बताए गए अपवादों के अधीन।'},
  {cat:'Selection',qEn:'How many players get selected each season?',qHi:'हर season कितने players select होते हैं?',aEn:'Each franchise builds its squad from the trial pool, so a select group of players from across registrants plays in the main season. Selection is purely merit-based through our transparent criteria-based assessment system.',aHi:'हर franchise trial pool से अपनी squad बनाती है, इसलिए registrants में से एक select group main season में खेलता है। Selection सिर्फ transparent criteria-based assessment system के ज़रिए merit-based होता है।'},
  // Payment
  ...
  {cat:'General',qEn:'How is BCPL different from other corporate leagues?',qHi:'BCPL दूसरी corporate leagues से कैसे अलग है?',aEn:'Three key differences: (1) Franchise system — real teams, real auctions, just like IPL. (2) Professional grounds and experienced coaches — not local maidan cricket. (3) Transparent fee structure — ₹' + F.phase1.bat + ' + GST entry, and no additional BCPL tournament participation fee if selected in auction (subject to Season 5 rules).',aHi:'तीन बड़े फर्क: (1) Franchise system — real teams, real auctions (IPL की तरह)। (2) Professional grounds और experienced coaches। (3) पारदर्शी fee structure — ₹' + F.phase1.bat + ' + GST entry, और auction में select होने पर कोई अतिरिक्त BCPL tournament participation fee नहीं (Season 5 नियमों के अधीन)।'},
];
