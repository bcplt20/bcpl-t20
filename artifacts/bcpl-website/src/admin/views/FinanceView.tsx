        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"16px 24px", borderBottom:"1px solid #33436B" }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            <button onClick={()=>{
              ...
              @media print{@page{size:A4;margin:10mm 10mm 14mm} .lh{-webkit-print-color-adjust:exact;print-color-adjust:exact} thead{display:table-header-group} tr{page-break-inside:avoid} .footer{page-break-inside:avoid} .tax-box{page-break-inside:avoid} .bill{page-break-inside:avoid}}</style></head>
              <body>
              <div class="lh">
              ...
              <div class="footer">
                ...
                <span>info@bcplt20.com · bcplt20.com</span>
              </div>
              </body></html>`);
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        ...
        <div style={{ display:"flex", gap:8 }}>
          ...
          <button onClick={()=>{
            ...
            w.document.write(`<!DOCTYPE html><html><head><title>BCPL Bulk Invoices</title><style>body{font-family:Arial;font-size:11px;padding:20px}.header{display:flex;align-items:center;gap:16px;border-bottom:3px solid #FF6B00;padding-bottom:12px;margin-bottom:20px}.logo{width:52px;height:52px;border-radius:50%;overflow:hidden;border:2px solid #FF6B00}.logo img{width:100%;height:100%;object-fit:cover}h1{margin:0;font-size:18px;color:#FF6B00}p{margin:2px 0;font-size:10px;color:#555}table{width:100%;border-collapse:collapse}th{background:#FF6B00;color:#fff;padding:7px;text-align:left;font-size:10px}td{padding:6px;border-bottom:1px solid #eee;font-size:10px}tr:nth-child(even){background:#FFF5EE}.footer{margin-top:20px;font-size:9px;color:#999;border-top:1px solid #eee;padding-top:10px}@media print{@page{size:A4 landscape;margin:8mm} body{padding:0} thead{display:table-header-group} tr{page-break-inside:avoid} .footer{page-break-inside:avoid} th{-webkit-print-color-adjust:exact;print-color-adjust:exact}}</style></head><body>
