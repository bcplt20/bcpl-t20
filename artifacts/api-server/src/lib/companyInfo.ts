 ...
 * Playing11 Private Limited"), which differs from the marketing footer entity
 * ("Kriparthi Playing 11 Pvt. Ltd."). Do not "correct" a GST invoice name.
 */
export const BCPL_LEGAL_NAME = "Kriparti Playing11 Private Limited";
export const BCPL_GSTIN = "07AAHCK4053D1ZS";
export const BCPL_ADDR =
  "Kriparti Playing11 Private Limited, 2nd Floor Back Side, RZ-108, Indra Park, Uttam Nagar, West Delhi, Delhi - 110059";
