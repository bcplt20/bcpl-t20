...
const PAGE_DEFAULTS: PageMetaDefault[] = [
  { path: "/",              label: "Home",            title: "BCPL T20 — Bhartiya Corporate Premier League | Season 5", description: "India's biggest corporate T20 cricket league. 10 franchise teams, 50+ cities, ₹6 Crore+ prize pool. Open to every working professional. Register at ₹299. #OfficeSeStadiumTak" },
  { path: "/register",      label: "Registration",    title: "Register for BCPL T20 Season 5 | Phase 1 at ₹299", description: "Sign up for BCPL T20 Season 5 in 3 easy steps: pay ₹299, upload your trial video, get selected for the franchise auction. India's biggest corporate cricket league." },
  { path: "/teams",         label: "Teams",           title: "BCPL T20 Teams — Franchise Squads | Season 5", description: "Explore all BCPL T20 franchise teams, squads, captains and season stats. Follow your city's team in India's biggest corporate cricket league." },
  ...
  { path: "/match-center",  label: "Match Center",    title: "BCPL T20 Live Scores & Matches | Season 5", description: "Live scores, results and highlights from BCPL T20 Season 5 — India's biggest corporate T20 cricket league." },
  ...
  { path: "/sponsors",      label: "Sponsors",        title: "BCPL T20 Sponsors & Partners | Season 5", description: "Partner with BCPL T20 and reach thousands of cricket-loving working professionals across 50+ Indian cities. Title, associate and official partner options." },
  { path: "/photos",        label: "Photos",          title: "BCPL T20 Photo Gallery | Season 5", description: "Match-day photos, team shoots and behind-the-scenes moments from BCPL T20 — India's biggest corporate cricket league." },
  { path: "/videos",        label: "Videos",          title: "BCPL T20 Videos & Highlights | Season 5", description: "Watch BCPL T20 match highlights, player stories and league moments from India's biggest corporate cricket league." },
