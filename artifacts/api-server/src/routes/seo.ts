...
const DEFAULT_OG_IMAGE = `${SITE_ORIGIN}/bcpl-assets/og-share.jpg`;

const PAGE_DEFAULTS: PageMetaDefault[] = [
  { path: "/",              label: "Home",            title: "Bhartiya Corporate Premier League | Season 5", description: "India's corporate T20 cricket league for working professionals. 10 franchise teams, ₹15 crore+ prize pool. Register at ₹299. #OfficeSeStadiumTak" },
  { path: "/register",      label: "Registration",    title: "Register for BCPL Season 5 | Phase 1 at ₹299", description: "Sign up for BCPL Season 5 in 3 easy steps: register, upload your cricket video and compete for selection. India's corporate cricket league." },
  { path: "/teams",         label: "Teams",           title: "BCPL Teams — Franchise Squads | Season 5", description: "Explore all BCPL franchise teams, squads, captains and season stats. Follow your city's team in India's corporate cricket league." },
  { path: "/players",       label: "Players",         title: "BCPL Players — Season 5 Squad Database", description: "Browse every player in BCPL Season 5 — search by name and filter by franchise team and role across all 10 city squads." },
  { path: "/trust",         label: "Selection Process", title: "How BCPL Selection Works | Trust & Transparency", description: "BCPL selection explained: video evaluation, physical trials, player score out of 100, city and role rankings, fees, eligibility and the appeal process." },
  { path: "/match-center",  label: "Match Center",    title: "BCPL Live Scores & Matches | Season 5", description: "Live scores, results and highlights from BCPL Season 5 — India's corporate T20 cricket league for working professionals." },
  { path: "/schedule",      label: "Schedule",        title: "BCPL Match Schedule | Season 5 Fixtures", description: "Full BCPL Season 5 fixture list — dates, venues and match timings for every franchise team." },
  { path: "/points-table",  label: "Points Table",    title: "BCPL Points Table | Season 5 Standings", description: "Latest BCPL Season 5 standings — wins, losses, NRR and playoff race, updated after every match." },
  { path: "/sponsors",      label: "Sponsors",        title: "BCPL Sponsors & Partners | Season 5", description: "Partner with BCPL and reach cricket-loving working professionals across India. Title, associate and official partner options." },
  { path: "/become-a-sponsor", label: "Become a Sponsor", title: "Become a BCPL Sponsor | Partner With BCPL", description: "Sponsor BCPL and reach India's working professionals across a full T20 season — trials, matches, digital and on-ground activation. Title, powered-by, associate and partner options with custom packages." },
  { path: "/photos",        label: "Photos",          title: "BCPL Photo Gallery — Auction & Team Shoots", description: "Photos from the BCPL Season 4 player auction and the official commercial shoot — teams, jerseys and league moments." },
  { path: "/videos",        label: "Videos",          title: "BCPL Videos — Auction & Highlights", description: "Watch the full BCPL Season 4 auction stream and official clips from the auction floor — India's corporate cricket league." },
  { path: "/about",         label: "About",           title: "About Bhartiya Corporate Premier League", description: "The story of BCPL: India's premier corporate cricket league for working professionals. Seasons, prize money, cities and the road to Season 5." },
  { path: "/faq",           label: "FAQ",             title: "BCPL FAQ — Registration, Fees & Rules", description: "Answers to common BCPL questions: ₹299 Phase 1 registration, trial videos, Phase 2, trial cities, eligibility and refunds." },
  { path: "/contact",       label: "Contact",         title: "Contact BCPL | Support & Queries", description: "Get in touch with the BCPL team for registration help, sponsorships and media queries." },
  { path: "/eligibility",   label: "Eligibility",     title: "BCPL Eligibility Criteria | Who Can Play", description: "Check who can register for BCPL Season 5 — age, employment and documentation requirements for India's corporate cricket league." },
  { path: "/code-of-conduct", label: "Code of Conduct", title: "BCPL Code of Conduct", description: "Player and team conduct rules for BCPL — fair play, discipline and on-ground behaviour standards." },
  { path: "/cricket-rulebook", label: "Rulebook",     title: "BCPL Cricket Rulebook | Playing Conditions", description: "Official BCPL playing conditions — match format, overs, powerplay, tie-breakers and umpiring rules." },
  { path: "/trial-rules",   label: "Physical Trial Rules", title: "Phase 2 Physical Trial Rules | BCPL", description: "How the BCPL physical trial works — the six-attempt rule, standardised assessment, 100-point scoring, blind evaluation, results and Auction Pool meaning." },
  { path: "/privacy",       label: "Privacy Policy",  title: "Privacy Policy | BCPL", description: "How BCPL collects, uses and protects your personal information." },
  { path: "/refunds",       label: "Refund Policy",   title: "Refund Policy | BCPL", description: "BCPL registration fee refund rules for Phase 1 and Phase 2." },
  { path: "/terms",         label: "Terms & Conditions", title: "Terms & Conditions | BCPL", description: "Terms and conditions for participating in BCPL Season 5." },
  ...
  { path: "/how-to-join",   label: "How to Join Guide", title: "How to Join a Corporate Cricket League in India", description: "Step-by-step guide: register, submit a 30–90s video, get a result within 15 days, attend physical trials and enter the auction. Join BCPL." },
