...
const PAGE_DEFAULTS: PageMetaDefault[] = [
  ...
  { path: "/videos",        label: "Videos",          title: "BCPL T20 Videos — Season 4 Auction & Highlights", description: "Watch the full BCPL Season 4 auction stream and official clips from the auction floor — India's corporate cricket league." },
