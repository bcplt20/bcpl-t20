...
const PAGE_DEFAULTS: PageMetaDefault[] = [
  ...
  { path: "/photos",        label: "Photos",          title: "BCPL T20 Photo Gallery | Season 5", description: "Match-day photos, team shoots and behind-the-scenes moments from BCPL T20 — India's corporate cricket league." },
  { path: "/videos",        label: "Videos",          title: "BCPL T20 Videos & Highlights | Season 5", description: "Watch BCPL T20 match highlights, player stories and league moments from India's corporate cricket league." },
